    ...
    <footer className="mt-24 bg-blue-900 py-16">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6">
          <a href="https://www.instagram.com/corym32/" className="text-blue-300 hover:text-white transition-colors">
          ...
          <a href="https://www.facebook.com/cory.mcgeehon.7" className="text-blue-300 hover:text-white transition-colors">
