    ...
    <section id="contact" className="py-12 bg-[#f8f9fa] relative overflow-hidden text-slate-800">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12 max-w-6xl mx-auto">
          ...
          {/* COLUMN 1 */}
          <div className="mt-48">
            <CardWrapper title="Inquiries" compact>
          ...
          {/* COLUMN 3 */}
          <div className="mt-48">
            <CardWrapper title="Social Presence" compact>
              <div className="flex justify-center gap-10 mt-10">
                <a href="https://www.instagram.com/corym32/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-900 transition-all hover:-translate-y-1">
                ...
                <a href="https://www.facebook.com/cory.mcgeehon.7" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-900 transition-all hover:-translate-y-1">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
